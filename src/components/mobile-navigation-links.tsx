    ...
    <nav aria-label="Mobile primary navigation" className="shell-mobile-links">
      ...
      {isAdministrator ? (
        ...
        >
          ...
          <Link className="shell-mobile-child-link" to="/resources" onClick={onSelectRoute}>
            Resources
          </Link>
          <Link className="shell-mobile-child-link" to="/settings" onClick={onSelectRoute}>
            Settings
          </Link>
          <Link className="shell-mobile-child-link" to="/booking-types" onClick={onSelectRoute}>
            Booking types
          </Link>
        </MobileNavigationModuleSection>
      ) : null}
